...
tutorial_event_recorder <- function(tutorial_id, tutorial_version, user_id, event, data) {
  ...
  if (!file.exists(log_file)) {
    readr::write_csv(
      tibble::tibble(datetime = Sys.time(), tutorial_id, tutorial_version, user_id, event = "Created Log", ""),
      log_file
    )
  }
  
  readr::write_csv(
    tibble::tibble(datetime = Sys.time(), tutorial_id, tutorial_version, user_id, event, data),
    log_file,
    append = TRUE
  )
}
